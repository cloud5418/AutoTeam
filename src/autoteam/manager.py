...
def _clear_asyncio_loop_state() -> None:
    try:
...
class _BrowserExecutor:
    """将 sync Playwright 操作派发到独立线程，避免落在任务线程里。"""
...
_browser_executor = _BrowserExecutor()
...
def _run_direct_register_once(mail_client, email, password, mail_account_id=None):
